...
const models: TsoaRoute.Models = {
    ...
    "AuthProvider": {
        "dataType": "refEnum",
        "enums": ["UserNameAndPassword","Facebook","Google"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "UserResponse": {
        "dataType": "refObject",
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/alive',
            ...
            function AliveController_getAlive(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getAlive.apply(controller, validatedArgs as any);
